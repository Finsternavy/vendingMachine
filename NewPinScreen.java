...
public class NewPinScreen extends JPanel {
	...
	public NewPinScreen() {
		...
		JLabel newAmountButton = new JLabel("ENTER AMOUNT TO ADD");
		newAmountButton.setHorizontalAlignment(SwingConstants.CENTER);
		newAmountButton.setFont(new Font("Tahoma", Font.PLAIN, 25));
		newAmountButton.setBounds(81, 117, 342, 46);
		add(newAmountButton);
		
		JTextPane newPinTextPane = new JTextPane();
		newPinTextPane.setEditable(false);
		newPinTextPane.setBounds(81, 71, 342, 46);
		add(newPinTextPane);
